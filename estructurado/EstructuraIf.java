...
public class EstructuraIf {
    public static void main(String[] args) {
        int topPuntaje = 100; //declaracion y asignacion en una sola linea
        ...
        if (topPuntaje > segundoPuntaje && topPuntaje <= 100) {
            System.out.println("El valor de top de puntaje es mayor a segundoPuntaje y es menor o igual a 100");
